...
export const migrateWorld = async function() {
  ui.notifications.info(`Applying BX System Migration for version ${game.system.data.version}. Please be patient and do not close your game or shut down your server.`, {permanent: true});
  ...
  game.settings.set("bx", "systemMigrationVersion", game.system.data.version);
  ui.notifications.info(`BX System Migration to version ${game.system.data.version} completed!`, {permanent: true});
};
